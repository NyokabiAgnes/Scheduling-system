...
<head>
    ...
    <title>DRIVING SCHOOL SCHEDULING SYSTEM</title>
...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">DRIVING SCHOOL SCHEDULING SYSTEM</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/Banana.jpeg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/Cherry.jpeg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/Melon.jpeg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/Tomato.jpeg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center" STYLE="margin-top: 30px">
    <button data-scroll-reveal="enter from the bottom after 0.2s"
            id="teacherLoginBtn" class="btn btn-info btn-lg">SCHOOL LOGIN
    </button>
    <button data-scroll-reveal="enter from the bottom after 0.2s"
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof. Kariuki</h3>
                    <hr/>
                    <h4 align="center">Dean<br/> Dean of Students</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Otieno</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> DSSS</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. Sally</h3>
                    <hr/>
                    <h4 align="center">Chairperson<br/>Driving School</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Find Us In Nairobi, CBD,
                </h4>
                <h4> Nairobi</h4>
                <h4><strong>Call:</strong> 0798112881 </h4>
                <h4><strong>Email: </strong>dsss@gmail.com</h4>
            </div>
